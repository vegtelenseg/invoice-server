...
export default function EditInvoice({ open, setOpen, selected }) {
  ...
  const {
    ...
    defaultValues: {
      ...
      invoiceDate: moment(targetInvoice.invoiceDate).toISOString(),
      billTo: targetInvoice.billTo,
      invoiceDue: targetInvoice.invoiceDue,
